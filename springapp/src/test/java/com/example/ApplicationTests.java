...
public class ApplicationTests {
	...
	public void TestCase1() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/signup").contentType(MediaType.APPLICATION_JSON).content(userOne)
				.accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andExpect(jsonPath("$").value("true"))
				.andReturn();

		// Login
		String dataOne = "{\"email\":\"Test@gmail.com\",\"password\":\"Testing\"}";
		mockMvc.perform(MockMvcRequestBuilders.post("/login").contentType(MediaType.APPLICATION_JSON).content(dataOne)
				.accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andExpect(jsonPath("$").value("true"))
				.andReturn();
	}
	...
	public void TestCase2() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.post("/admin/addProduct").contentType(MediaType.APPLICATION_JSON)
				.content(prodOne).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andReturn();
	}
	...
	public void TestCase4() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/admin").accept(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk()).andDo(print())
				.andExpect(MockMvcResultMatchers.jsonPath("$[*].productName").exists())
	...
	public void TestCase5() throws Exception {
		...
		mockMvc.perform(MockMvcRequestBuilders.get("/admin/orders").accept(MediaType.APPLICATION_JSON))
